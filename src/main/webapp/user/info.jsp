        ...
        <div class="data_list_title"><span class="glyphicon glyphicon-edit"></span>&nbsp;个人中心</div>
            <div class="container-fluid">
                <div class="row" style="padding-top: 20px;">
                    <div class="col-md-8">
                        <%--表单类型enctype="mulipart/formdata"提交方式 method="post"--%>
                        <div class="form-horizontal" method="post" action="user" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $("#nickName").blur(function(){
        ...
        //从session作用域中获取用户信息
        var nick='${user.nick}';
        //如果用户昵称与session作用域中的昵称一致，则return
        if(nickName==nick){
            return;
        }
        //如果用户昵称做了修改
